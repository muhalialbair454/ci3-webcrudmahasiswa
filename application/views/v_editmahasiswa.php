...
<body>
    ...
    <main>
        <div class="container">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo site_url("updateeditmahasiswa"); ?>" method="POST" name="formeditmahasiswa" id="formeditmahasiswa" enctype="multipart/form-data">
                        <input type="hidden" name="txtidmahasiswa" id="txtidmahasiswa" class="form-control" placeholder="Masukan Id Mahasiswa" value="<?php echo $getDataMahasiswa->id_mahasiswa; ?>">
                        <div class="form-group row">
                            <label for="ffoto" class="col-sm-2 col-form-label">Foto</label>
                            <div class="col-sm-10">
                                <input type="file" name="ffoto" id="ffoto" class="form-control" placeholder="Masukan Foto" value="<?php echo $getDataMahasiswa->foto; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="txtnpm" id="txtnpm" class="form-control" placeholder="Masukan NPM" value="<?php echo $getDataMahasiswa->npm; ?>">
                                <div class="form-error">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="txtnamamahasiswa" id="txtnamamahasiswa" class="form-control" placeholder="Masukan Nama Mahasiswa" value="<?php echo $getDataMahasiswa->nama_mahasiswa; ?>">
                                <div class="form-error">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="date" name="dtanggallahir" id="dtanggallahir" class="form-control" placeholder="Masukan Tanggal Lahir" value="<?php echo $getDataMahasiswa->tanggal_lahir; ?>">
                                <div class="form-error">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="txtjurusan" id="txtjurusan" class="form-control" placeholder="Masukan Jurusan" value="<?php echo $getDataMahasiswa->jurusan; ?>">
                                <div class="form-error">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="txtalamat" id="txtalamat" class="form-control" placeholder="Masukan Alamat" value="<?php echo $getDataMahasiswa->alamat; ?>">
                                <div class="form-error">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="email" name="eemail" id="eemail" class="form-control" placeholder="Masukan Email" value="<?php echo $getDataMahasiswa->email; ?>">
                                <div class="form-error">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="txtnotelepon" id="txtnotelepon" class="form-control" placeholder="Masukan Nomor Telepon" value="<?php echo $getDataMahasiswa->no_telepon; ?>">
                                <div class="form-error">
